...
class BargraphIndividual extends Component {
  state = {
  ...
  getDataFromApi = async () => {
    ...
    const ApiUrl = `http://localhost:8000/api/barChart/${selectedMonth}`
    ...
    return (
      <>
        <li className="li-item">
          ...
          <BarChartPage barChartData={jsData} />
        </li>
      </>
    )
  }
...
export default BargraphIndividual
